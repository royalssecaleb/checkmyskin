...
export default function CheckSkinCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCheckskinstatus(initialValues.checkskinstatus);
    setLong(initialValues.long);
    setMelanoma(initialValues.melanoma);
    setDermatologist(initialValues.dermatologist);
    setDiameter(initialValues.diameter);
    setFactors(initialValues.factors);
    setSevere(initialValues.severe);
    setRelevant(initialValues.relevant);
    setDistributed(initialValues.distributed);
    setRashLocation(initialValues.rashLocation);
    setRashType(initialValues.rashType);
    setSymptoms(initialValues.symptoms);
    setDoctorAnswer(initialValues.doctorAnswer);
    setPayment_id(initialValues.payment_id);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CheckSkin(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CheckSkinCreateForm")}
      {...rest}
    >
      <TextField
        label="Email"
