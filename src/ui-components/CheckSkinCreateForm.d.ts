...
export declare type CheckSkinCreateFormInputValues = {
    email?: string;
    age?: number;
    gender?: string;
    type?: string;
...
export declare type CheckSkinCreateFormValidationValues = {
...
export declare type CheckSkinCreateFormOverridesProps = {
    CheckSkinCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CheckSkinCreateFormProps = React.PropsWithChildren<{
    overrides?: CheckSkinCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: CheckSkinCreateFormInputValues) => CheckSkinCreateFormInputValues;
    onSuccess?: (fields: CheckSkinCreateFormInputValues) => void;
    onError?: (fields: CheckSkinCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CheckSkinCreateFormInputValues) => CheckSkinCreateFormInputValues;
    onValidate?: CheckSkinCreateFormValidationValues;
} & React.CSSProperties>;
export default function CheckSkinCreateForm(props: CheckSkinCreateFormProps): React.ReactElement;
